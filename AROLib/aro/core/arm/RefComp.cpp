...
//template <>
Ref<Comparable<String>>::Ref(Ref<String>&& strRef)
{
   ref = strRef.ref;
...
//template <>
Ref<Comparable<String>>::Ref(Ref<Comparable<String>>&& strRef)
{
   ref = strRef.ref;
...
//template <>
Ref<Comparable<String>>& Ref<Comparable<String>>::operator=(Ref<String>&& strRef)
{
   if(ref != nullptr)
      Arm::remove(ref, this);
...
//template <>
Ref<Comparable<String>>& Ref<Comparable<String>>::operator=(Ref<Comparable<String>>&& strRef)
{
   if(this != &strRef)
   {
      if(ref != nullptr)
